...
# Two fields with different frequencies: ω and 2ω.
# B_sum(tN) ∝ cos(pi/3) + cos(2pi/3) = 0.5 - 0.5 = 0
t_end = max_steps * dt
omega = (pi / 3.0) / t_end  # cos(ω tN) = +0.5
phase = 0.0
path = "../../../../openPMD-example-datasets/example-femm-3d.h5"
