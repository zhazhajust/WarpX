    ...
    CommonLaserParameters params)
{
    ...
    std::string focal_type = "linear";
    ppl.query("focal_type", focal_type);
    if (focal_type == "math") {
        ...
        m_params.h_focal_spot = parse_math_func("focal_spot");
        m_params.h_focal_delay = parse_math_func("focal_delay");
        m_params.h_focal_weight = parse_math_func("focal_weight");
        m_params.h_focal_phase = parse_math_func("focal_phase");
