                                   ...
                                   MomentumPushType momentum_push_type)
{
    ...
    const bool do_fourier_radiation =
    ...
    const Real radiation_min_particle_energy =
        (do_fourier_radiation) ? fourier_radiation->MinParticleEnergy() : 0._rt;
        ...
        [=] AMREX_GPU_DEVICE (long ip, auto exteb_control, auto qed_control)
    {
        ...
        if (do_fourier_radiation) {
            ...
            const Real gamma_new = 1._rt / gamma_inv_new;
            const Real particle_energy = gamma_new * mass * PhysConst::c * PhysConst::c;
            if (particle_energy < radiation_min_particle_energy) {
